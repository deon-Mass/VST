package cd.digitalEdge.vst.PrinterBluetooth;
...
public class ImprimerActivity extends AppCompatActivity implements Runnable {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(context, "DeviceConnected", Toast.LENGTH_SHORT).show();
        }
    };
